...
const stripe = require('stripe')(process.env.SRTRIPE_SECRET_KEY)
...
async function run() {
  try {
    ...
    const paymentCollection = client.db("bistroCafeDB").collection("payments");
    ...
    app.post("/create-payment-intent", async (req, res) => {
      ...
      console.log(amount, 'inside the the intent');
